    ...
    return Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            buildPackageComponent("Package 2", "250 EGP          per 3 months"),
...
Widget buildPackageComponent(String packageName,String pricePerDate){
    return Container(
        ...
        Container(child: Text(packageName , style: TextStyle(fontSize: 35 , color: Colors.white)),
          color: Colors.grey,
          width: 300,
          height: 50,
        ...
        SizedBox(height: 0),
        Container(child: Text(pricePerDate, style: TextStyle(fontSize: 30, color: Colors.white)),
          height: 120,
          width:300,
